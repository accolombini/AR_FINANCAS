...
# Pipeline principal para execução das etapas de coleta, processamento e análise dos dados de ativos
...
def main():
    """Função principal que executa o pipeline de coleta, processamento e análise dos dados."""
